...
async function ContactUs(req, res) {
  try {
    ...
    const mailOptions = {
      ...
      to: "apnainsti@kgpian.iitkgp.ac.in", // receiver address
      subject: "New Query", // subject line
      html: `<div style="margin: 0; margin-bottom: 16px; background-color: #f0f0f0; border-radius: 10px; padding: 16px; box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2);">
